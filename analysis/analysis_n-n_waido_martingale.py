...
def main():   
    ...
    for m in range(4):
        ...
        for ii in range(len(redata_info)):
            ...
            kakekin = 1
            if rieki_l[-1] < 0:
                kakekin = (abs(rieki_l[-1]) / ave_odds + 100) // 100
            elif rieki_l[-1] > 0:
                rieki_sum = 0
            #end
