    ...
    for m in range(4):
        ...
        for ii in range(len(redata_info)):
            ...
            for j in range(len(combi)):
                ...
                if pred_rank1 == pred_rank2 or pred_rank1 == pred_rank3 or pred_rank3 == pred_rank2:
                    continue
                #end
        ...
        #end
        tn += "\n"
        for i in range(len(ll7)):
            tn += str(ll7[i])
            tn += ","
        #end

        tn += "\n"
        tn += " " +str(len(ll3)) + "-" +str(len(ll7)) + "-" +str(len(ll7)) + " formation (6300 yen)"
        tn += "\n"
