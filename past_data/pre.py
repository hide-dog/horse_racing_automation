...
def main():
    ...
    # input files
    # ------------------------------------
    # fff = glob.glob("raw_data/2021_data/*/*")
    fff = glob.glob("raw_data/*/*/*")

    # ------------------------------------
    # lists
    # ------------------------------------
    try:
        with open("hn_data", "r", encoding="shift-jis") as f:
            hn = f.readlines()
        #end
        with open("tn_data", "r", encoding="shift-jis") as f:
            tn = f.readlines()
        #end
        hn_ite = 1 + len(hn)
        tn_ite = 1 + len(tn)
    ...
    for l in range(len(fff)):
        ...
        # read files
        # ------------------------------------    
        with open(fff[l], "r", encoding="utf-8") as f:
            lines = f.readlines()
        #end
        ...
        try:
            ...
            # output
            # ------------------------------------
            fout = fff[l].replace("raw_data", "re_data") + "_info"
            print(fout)
            with open(fout, "w+", encoding="shift-jis") as f:
            ...
            fout = fff[l].replace("raw_data", "re_data") + "_result"
            with open(fout, "w+", encoding="shift-jis") as f:
    ...
    # output hh, ht, 
    with open("hn_data", "w", encoding="shift-jis") as f:
        for i in range(len(hn)):
            f.write(hn[i])
            f.write("\n")
        #end
    #end
    with open("tn_data", "w", encoding="shift-jis") as f:
